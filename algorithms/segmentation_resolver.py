...
class SegmentationResolver:
    ...
    def __init__(self, params):
        ...
        self.im_sizes = params['image_sizes']
    ...
    def segment(self, algorithm="kmeans"):
        ...
        for index,(rgb_img, filename, im_size) in enumerate(zip(self.images, self.filenames, self.im_sizes)):
            # transform image array into a 2-D array. 
            reshaped, image, = reshape_image(rgb_img, im_size)
            ...
            for i,cluster in enumerate(self.clusters):
                ...
                segmented_image, image_boundaries = self.execute_algorithm(algorithm,filtered_image,image, im_size, cluster)
                unfiltered_segment, unfiltered_boundaries = self.execute_algorithm(algorithm,reshaped, image, im_size, cluster)
                
                # import pdb; pdb.set_trace()
                filec = algorithm +"/"+'color/' +filename.split('.')[0] +'_clr.jpg'
                ...
                # save_to_folder(path=filec, image=segmented_image, imType='a')
